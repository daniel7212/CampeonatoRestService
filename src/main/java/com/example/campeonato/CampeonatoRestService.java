...
import com.example.campeonato.model.Equipo;
import com.example.campeonato.model.Jugador;
...
@RestController
@Tag(name="CampeonatoRestService", description="API de la Liga")
public class CampeonatoRestService {
	@Autowired
	private Liga liga;
	
	@Operation(summary = "Equipos de la liga", description = "Lista de equipos de la liga", 
			tags = {"CampeonatoRestService"})
	@GetMapping("/equipos")
	...
	@Operation(summary = "Actualiza equipo", description = "Actualiza la información un equipo existente", tags = {"CampeonatoRestService"})
	...
	@Operation(summary = "Añadir jugador", description = "Añadir un jugador existente a un equipo", tags = {"CampeonatoRestService"})
	...
	@Operation(summary = "Crear equipo", description = "Crear un nuevo equipo", tags = {"CampeonatoRestService"})
	@PostMapping("/equipos")
	...
	@Operation(summary = "Suprimir equipo", description = "Suprimir un equipo", tags = {"CampeonatoRestService"})
